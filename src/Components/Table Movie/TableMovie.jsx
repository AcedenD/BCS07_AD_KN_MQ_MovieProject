...
const TableMovie = ({ searchKeyword, showDrawer, showDrawer2}) => {
        ...
        },
        {
            ...
            render: (_, record) => (
                <Space size="middle">
                    ...
                    <button onClick={() => showDrawer(record)} className='py-2 px-5 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 suration-500'
                    title="Sửa"><i class="fa-solid fa-pen-to-square"></i></button>

                    <button onClick={() => showDrawer2(record)} className='py-2 px-5 bg-green-600 text-white rounded-lg hover:bg-green-700 suration-500' title="Tạo Lịch Chiếu"><i class="fa-solid fa-calendar-days"></i></button>
